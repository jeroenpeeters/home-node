...
function getDateString(){
    var d = new Date()
    return (d.getMonth()+1) + "/" + (d.getDate()>9?d.getDate():'0'+d.getDate()) + " " + d.getHours() + ":" + d.getMinutes() + ":" + d.getSeconds() + " ";
}
...
function PLOnOff(match) {
    ...
    return getDateString() +
        "Tx PL HouseUnit: " + address + "\r\n"+
        getDateString() + "Tx PL House: " + address.charAt(0) + " Func: " + command.substr(0,1).toUpperCase() + command.substr(1) + "\r\n";
